...
class Checkout
{
    ...
    public function get_shipping_to_order($order_info)
    {
        ...
        $shipping_rate = new WC_Shipping_Rate('', $order_info->shipping_method_title, $shipping_cost, [], $order_info->shipping_method_id);
    ...
    public function add_address_to_order($user_data, $order)
    {
        ...
        if (isset($user_data['ship_to_different_address']) && $user_data['ship_to_different_address'] == 1) {
    ...
    public function add_product_to_order($cart_info, $order)
    {
        ...
        foreach ($cart_info['cart_contents'] as $key => $cart_product) {
    ...
    public function get_shipping_address($order_info)
    {
        return [
            ...
            'country' => isset($order_info['shipping_postcode']) ? $order_info['shipping_postcode'] : null,
            'postcode' => isset($order_info['shipping_country']) ? $order_info['shipping_country'] : null,
        ];
    }
}
